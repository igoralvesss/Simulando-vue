<template>
    ...
    <v-content>
        <v-container class="fill-height flex-wrap" fluid>
            ...
            <v-card width="800px" class="pa-5">
                ...
                <div class="d-flex flex-wrap justify-space-around">
                    <v-card class="elevation-0 pa-5 d-flex flex-column justify-start text-wrap" width="400" height="270" >
                        <v-card-title class="headline mb-4">Dados estatísticos Simulando</v-card-title>
